...
#define Step1_En 		GPIO_Pin_8
#define Step1_Stp 		GPIO_Pin_9
#define Step1_Dir		GPIO_Pin_10
#define Step1_EnMode	Bit_SET

#define Step2_GPIO 		GPIOA
#define Step2_RCC_GPIO 	RCC_APB2Periph_GPIOA
#define Step2_En 		GPIO_Pin_1
#define Step2_Stp 		GPIO_Pin_3
#define Step2_Dir 		GPIO_Pin_5
